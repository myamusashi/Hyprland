...
---@field ['tap-and-drag'] boolean|nil
---@field ['tap-to-click'] boolean|nil
...
---@field animation? string
---@field border_color? string|HL.Gradient
...
---@field max_size? HL.Vec2Like
---@field maximize? boolean
---@field min_size? HL.Vec2Like
...
---@field no_close_for? integer|boolean
...
---@field scroll_mouse? number|boolean
---@field scroll_touchpad? number|boolean
---@field scrolling_width? number|boolean
---@field size? string
...
---@field exec_once fun(...): any
---@field exec_raw fun(...): any
---@field exec_shutdown fun(...): any
---@field exit fun(...): any
---@field focus fun(...): any
...
---@field get_notifications fun(): HL.Notification[]
...
---@field cursor HL.CursorNamespace
---@field group HL.GroupNamespace
---@field notification HL.NotificationNamespace
---@field plugin HL.PluginNamespace
---@field window HL.WindowNamespace
---@field workspace HL.WorkspaceNamespace
local __HL_API = {}

---@class HL.CursorNamespace
---@field move fun(...): any
---@field move_to_corner fun(...): any
local __HL_CursorNamespace = {}

---@class HL.GroupNamespace
...
local __HL_GroupNamespace = {}

---@class HL.NotificationNamespace
---@field create fun(text: string, opts?: HL.NotificationOptions): HL.Notification
...
local __HL_WindowNamespace = {}

---@class HL.WorkspaceNamespace
---@operator call:fun(...): any
---@field move fun(...): any
---@field rename fun(...): any
---@field swap_monitors fun(...): any
local __HL_WorkspaceNamespace = {}
...
---@field ['dwindle.pseudotile'] boolean
...
---@field ['input.touchpad.tap-and-drag'] boolean
---@field ['input.touchpad.tap-to-click'] boolean
